#
# Module manifest for module 'PSGet_UpdateServicesDsc'
#
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/mgreenegit/UpdateServicesDsc/'

        # A URL to an icon representing this module.
        # IconUri = ''

        # ReleaseNotes of this module
        ReleaseNotes = 'https://github.com/mgreenegit/updateservicesdsc#versions'
